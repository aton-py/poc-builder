...
*/
builder.init("bc1cbdf0da594c7abd60bd297bb45922");
...
Builder.registerComponent(
  dynamic(() => import("../components/BasicCard")),
  {
    name: "Basic Card",
    inputs: [
...
Builder.registerComponent(
  dynamic(() => import("../components/SimplePopper")),
  {
    name: "Popper",
    inputs: [
      { name: "title", type: "text" },
...
Builder.registerComponent(
  dynamic(() => import("../components/BasicModal")),
  {
    name: "Modal",
    inputs: [
      { name: "buttonTxt", type: "text" },
